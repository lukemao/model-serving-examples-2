...
def run_zeroshot(data):
    ...
    try:
        try:
            ...
            tokenizer = AutoTokenizer.from_pretrained('./distilbert-base-uncased_tokenizers')
            model = AutoModel.from_pretrained('./distilbert-base-uncased_model')
        except:
            print('loading and save models')
            tokenizer = AutoTokenizer.from_pretrained('distilbert-base-uncased-finetuned-sst-2-english')
            model = AutoModel.from_pretrained('distilbert-base-uncased-finetuned-sst-2-english')
            tokenizer.save_pretrained('./distilbert-base-uncased_tokenizers')
